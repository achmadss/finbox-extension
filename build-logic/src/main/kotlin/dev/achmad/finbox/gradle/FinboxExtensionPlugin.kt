 ...
 */
/**
 * FQN of the class generated by `:compiler` from the module's `@Parser` class.
 * Must match GENERATED_PACKAGE/GENERATED_CLASS in ParserProcessor.
 */
private const val GENERATED_CLASS = "dev.achmad.finbox.extension.generated.GeneratedParser"
...
class FinboxExtensionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            ...
            // @Parser class, so running it there would only fail the build.
